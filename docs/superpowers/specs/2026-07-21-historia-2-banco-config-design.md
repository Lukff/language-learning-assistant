...
> Spec for the second implementation slice of Phase 1 (`docs/fase-1-mvp.md`, Story 2).
...
onward (`docs/fase-1-mvp.md`).

## Acceptance criteria (from `docs/fase-1-mvp.md`, Story 2)
...
- [ ] Embedded `goose` migrations (`embed.FS`); schema v1: `lessons`, `transcripts`, `jobs`,
      `prompts` (the latter two already in the format defined in `decisoes-tecnologia.md`, even
