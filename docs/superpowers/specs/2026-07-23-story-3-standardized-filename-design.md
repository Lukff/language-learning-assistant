...
> Additional slice on top of Story 3 (`docs/phase-1-mvp.md`), on the confirmation flow
> (`ImportService.ConfirmImport`) already implemented and described in
> `docs/superpowers/specs/2026-07-22-story-3-import-lesson-design.md`. Does not reopen what was
...
## Acceptance criterion (new, added to Story 3 in `docs/phase-1-mvp.md`)
