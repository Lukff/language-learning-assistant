...
> Covers the full Story 3b (`docs/phase-1-mvp.md`) and resolves the project's **technical risk 2**
...
> `docs/superpowers/specs/2026-07-22-story-3-import-lesson-design.md`.
...
## Acceptance criteria (Story 3b, `docs/phase-1-mvp.md`)
