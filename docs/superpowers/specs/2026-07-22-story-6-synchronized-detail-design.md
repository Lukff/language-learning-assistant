...
utterance following playback. This story closes M3 ("complete MVP") from `phase-1-mvp.md`.
...
scope for Phase 1 (`phase-1-mvp.md`). Building the tab bar now would be UI for a feature that
