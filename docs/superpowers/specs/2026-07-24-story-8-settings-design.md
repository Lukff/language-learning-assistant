...
> Covers the full Story 8 (`docs/phase-1-mvp.md`). Deliberately minimal scope: only what covers the
...
- STT/LLM provider selection, cost estimation, or any other configuration field besides
  `storage_root` and the credential (Phase 5, `docs/phase-1-mvp.md`).
...
## Acceptance criteria (from `docs/phase-1-mvp.md`, Story 8)
