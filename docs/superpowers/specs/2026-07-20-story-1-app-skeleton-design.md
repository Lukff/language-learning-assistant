...
> Spec for the first implementation slice of Phase 1 (`docs/phase-1-mvp.md`, Story 1).
...
drag-and-drop, video. All of that is Story 2 onward (`docs/phase-1-mvp.md`).

## Acceptance criteria (from `docs/phase-1-mvp.md`, Story 1)
