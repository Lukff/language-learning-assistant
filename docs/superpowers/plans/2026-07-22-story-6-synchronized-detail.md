...
- Reference spec: `docs/superpowers/specs/2026-07-22-story-6-synchronized-detail-design.md`.
...
**Files:**
- Modify: `docs/phase-1-mvp.md` (marks Story 6's criteria, adds a row to the progress table)
...
- [ ] **Step 4: Update `docs/phase-1-mvp.md` — mark Story 6's criteria (lines 154-159) as done, with the same pending-visual-verification caveat used in the previous stories**
...
(`phase-1-mvp.md:154-159`) and every decision in the spec
(`docs/superpowers/specs/2026-07-22-story-6-synchronized-detail-design.md`) has a
corresponding task.
