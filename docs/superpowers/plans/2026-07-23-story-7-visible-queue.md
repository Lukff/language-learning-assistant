...
Full spec: `docs/superpowers/specs/2026-07-23-story-7-visible-queue-design.md`.
...
**Files:**
- Modify: `docs/phase-1-mvp.md:171-176` (Story 7 acceptance criteria)
- Modify: `docs/phase-1-mvp.md` (the "Progress log" table, new row at the end)
...
- [ ] **Step 4: Mark Story 7's acceptance criteria in `docs/phase-1-mvp.md`**
