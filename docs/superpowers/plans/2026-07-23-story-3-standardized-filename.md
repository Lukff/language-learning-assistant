...
- [ ] **Step 4: Check off the acceptance criterion in `docs/phase-1-mvp.md`**

In `docs/phase-1-mvp.md`, in the Story 3 section, replace:
...
```bash
git add services/import_test.go docs/phase-1-mvp.md
