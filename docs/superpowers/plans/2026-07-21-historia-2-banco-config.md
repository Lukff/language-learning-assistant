...
- Keyring failures (Secret Service unavailable on Linux — risk 3 in `docs/fase-1-mvp.md`) surface
...
"Secret Service unavailable" failure from risk 3 in `docs/fase-1-mvp.md`, deterministically. (The
...
**Files:**
- Modify: `docs/fase-1-mvp.md` (progress table + checkboxes)
...
- **Deviation from the approved design doc, noted deliberately:** the design doc
  (`docs/superpowers/specs/2026-07-21-historia-2-banco-config-design.md`) proposed wrapping
...
- **Environment discovery, not a design change:** building/vetting/testing any package that
  ...
  in `docs/fase-1-mvp.md`'s risk list (which only calls out the *keyring* half of the Linux story,
