...
> `docs/phase-0-validation.md`. Notes are **paraphrased** — no literal transcription of speech
> passages, tutor names, or any data identifying a specific lesson/person. Feeds the
> decision recorded in `docs/technology-decisions.md` ("LLM-based analysis" section).
...
skipped for now. See `docs/technology-decisions.md` for the full rationale.
