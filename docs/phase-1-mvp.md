...
>
> Base: Wails v3 (alpha, pinned) + Svelte 5 + the Go stack defined in `technology-decisions.md`.
...
- [x] `goose` migrations embedded (`embed.FS`); schema v1: `lessons`, `transcripts`, `jobs`, `prompts` (the last two already in the format defined in `technology-decisions.md`, even without full use in this phase).
...
design in `docs/superpowers/specs/2026-07-22-story-3-import-lesson-design.md`.
...
|------|-----------------|-------------|
| 20/07/2026 | Story 1 implemented: Wails v3 + Svelte 5 skeleton (sidebar, empty header, 3 placeholder screens); production build confirmed | wails3 v3.0.0-alpha2.117 pinned; fonts self-hosted via @fontsource |
